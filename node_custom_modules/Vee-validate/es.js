!(function(e, n) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(n)
      : ((e.__vee_validate_locale__es = e.__vee_validate_locale__es || {}),
        (e.__vee_validate_locale__es.js = n()));
})(this, function() {
  "use strict";
  var e = {
    name: "es",
    messages: {
      ...
      alpha_dash: function(e) {
        return (
          "El campo " + e + " solo debe contener letras, números y guiones."
        );
      },
      ...
      between: function(e, n) {
        return (
          "El campo " + e + " debe estar entre " + n[0] + " y " + n[1] + "."
        );
      },
      ...
      digits: function(e, n) {
        return (
          "El campo " +
          e +
          " debe ser númerico y contener exactamente " +
          n[0] +
          " dígitos."
        );
      },
      ...
      max: function(e, n) {
        return (
          "El campo " + e + " no debe ser mayor a " + n[0] + " caracteres."
        );
      },
      ...
      min: function(e, n) {
        return (
          "El campo " + e + " debe tener al menos " + n[0] + " caracteres."
        );
      },
      ...
      size: function(e, n) {
        return (
          ...
          (function(e) {
            ...
            return (
              1 * (e / Math.pow(1024, n)).toFixed(2) +
              " " +
              ["Byte", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][n]
            );
          })(n[0]) +
          "."
        );
