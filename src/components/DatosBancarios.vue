    ...
    .layout-inner
      form.form.form_big(
        ...
        fieldset.form-section
          legend.subhead.form-section__title Datos Bancarios
            p.form-section__subtitle Agrega tu información bancaria para depositar tus ganancias.
          .form-section__inner
            .form__row
              label.form__label(
                for='rutUser') Rut
            ...
            .form__row
              label.form__label(
                for='nameUser') Nombre y Apellido
              input.form__control(
                id='nameUser',
                type='text')
            .form__row
              label.form__label(
                for='userBank') Selecciona el Banco
              select.form__select
                option
                option item2
                option item3
            ...
            .form__row
              label.form__label(
                for='userAccount') Selecciona tu tipo de cuenta
              select.form__select
                option
                option item2
                option item3
            ...
            .form__grid.form__grid_center.form__row_away
              .form__row
                a.btn(href='#', title='Cancelar') Cancelar
              .form__row
                a.btn.btn_solid(href='#', title='Agregar método de pago') Agregar Método de pago
  ...
  .step
    .layout-inner
      form.form.form_big(
        ...
        fieldset.form-section
          legend.subhead.form-section__title Datos Bancarios
            p.form-section__subtitle Modificar información bancaria para depositar tus ganancias.
          .form-section__inner
            .form__row
              label.form__label(
                for='rutUser') Rut
