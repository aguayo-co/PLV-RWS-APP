  ...
  section.blog.blog_top
    .blog__inner
      header.blog__header
        ...
        p.blog__kicker Todo lo que tienes que saber sobre tus ganancias en Prilov.
    article.blog__body
      .blog__out.blog__out_right
        .blog__spread.blog__spread_upside
          ...
          .blog__copy
            .blog__subarticle
              h2.blog__headline Cuando vendas un producto, siempre se generarán créditos en tu cuenta Prilov. Puedes usarlos para comprar otros productos o solicitar el pago a tu cuenta bancaria
