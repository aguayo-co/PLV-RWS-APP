  ...
  section.blog.blog_top
    ...
    .blog__inner
      article.blog__body.blog__body_slot
        ...
        .blog__copy
          p Prilov cobrará un 20% de comisión del valor de los productos por cada venta que se genere; generándose el 80% del valor de los productos en créditos, más el costo de despacho pagado por la compradora. Por ejemplo, si el precio del producto es $10.000 y el costo de despacho es $1.000, entonces generaremos créditos por $8.000 + $1.000 = $9.000.
